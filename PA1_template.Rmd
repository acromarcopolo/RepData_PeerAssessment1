...
#### 1. Total number of steps taken per (ignoring missing values for now):
```{r}
...
```{r}
hist(datesSum$sum, main = " Distribution of Daily Number of Steps\n(missing values removed)", col="gray", xlab="Number of Steps / Day", ylim = c(0,35))
```
